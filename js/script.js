...
async function displayMovieDetails() {
    ...
    <div class="details-top">
        ...
        <div class="details-bottom">
          <h2>Movie Info</h2>
          <ul>
            <li><span class="text-secondary">Budget:</span> $${addCommasToNumer(movie.budget)}</li>
            <li><span class="text-secondary">Revenue:</span> $${addCommasToNumer(movie.revenue)}</li>
...
function displaySearchResults(results) {
  ...
  results.forEach((result) => {
        ...
        document.querySelector('#search-results-heading').innerHTML = `<h2>${results.length} of ${global.search.totalResults} Results for the ${global.search.term}</h2>`;
